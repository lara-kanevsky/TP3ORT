...
interface AuthenticationApi {
    ...
    suspend fun getNextQuestionScreen(@Path("type") formType: String, @Path("screenId") id: String, @Body questionScreenResponse: QuestionScreenResponse): Response<QuestionScreenDataResponse>
